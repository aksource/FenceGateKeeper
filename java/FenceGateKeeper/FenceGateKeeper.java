...
public class FenceGateKeeper
{
	...
	{
		fenceGate = new kpBlockFenceGate().setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundTypeWood).setBlockName("fenceGate");
        GameRegistry.registerBlock(fenceGate, ItemBlock.class, "fence_gate", "minecraft");
	}
